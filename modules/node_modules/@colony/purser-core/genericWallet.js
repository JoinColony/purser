...
export default class GenericWallet {
  ...
  constructor({
    ...
    Object.defineProperties(this, {
      address: { value: otherAddresses[0].address, ...SETTERS},
      chainId: { value: chainId, ...WALLET_PROPS},
      type: { value: TYPE_GENERIC, ...GENERIC_PROPS},
      subtype: { value: SUBTYPE_GENERIC, ...GENERIC_PROPS},
      /**
       ...
       */
      sign: { value: async () => {}, ...GENERIC_PROPS},
      signMessage: { value: async () => {}, ...GENERIC_PROPS},
      verifyMessage: {
