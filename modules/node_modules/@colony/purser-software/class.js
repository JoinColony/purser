...
export default class SoftwareWallet {
  ...
  constructor(ethersInstance: WalletArgumentsType = {}) {
    ...
    Object.defineProperties(this, {
      ...
      type: { value: TYPE_SOFTWARE, ...WALLET_PROPS},
      subtype: { value: SUBTYPE_ETHERS, ...WALLET_PROPS},
      ...
      sign: {
        ...
        value: async (transactionObject: TransactionObjectType) => {
            ...
            return signTransaction(
              { ...transactionObject, chainId: transactionChainId,
                /*
  ...
  get publicKey(): Promise<string | void> {
    ...
    return (async () => {
      ...
      Object.defineProperty(
        (this: any),
        'publicKey',
        { ...GETTERS, value: Promise.resolve(normalizedPublicKey),},
      );
